...
- (id) initWithKnightData:(KnightData *)data area:(Rectangle *)area layerDepth:(float)layerDepth {
    ...
    if (self != nil) {
        // init pane
        statPane = [[Image alloc] initWithTexture:[CamelotTextureComponent getInterfaceProp:InterfacePropPane] position:[Vector2 vectorWithX:area.x + 220 y:area.y + 199]];
        ...
        unitTypeBorder = [[Image alloc] initWithTexture:[CamelotTextureComponent getInterfaceProp:InterfacePropSlotDice] position:[Vector2 vectorWithX:area.x + 485 y:area.y + 208]];
        unitTypeBorder.layerDepth = layerDepth + INTERFACE_LAYER_DEPTH_BACK;
        [items addObject:unitTypeBorder];
        
        unitType = [[Image alloc] initWithTexture:[CamelotTextureComponent getInterfaceProp:InterfacePropSlotDice] position:[Vector2 vectorWithX:area.x + 485 y:area.y + 208]];
