...
- (id) initWithLevel:(Level*)theLevel gameHud:(GameHud *)hud {
    self = [super initMonster:MonsterTypeWarrior level:theLevel gameHud:hud expType:ExpTypeNormal entityType:Agility health:[Constants brawlerHealthPoints] damageType:[Constants brawlerDamageType] maxRadius:60];
    if (self != nil) {
        // init stats
